...
export default function(app) {
  ...
  const send = function(method, type, eventId, data) {
    data = data || {};
  ...
  const sendToUser = function(method, type, eventId, data, userId) {
  ...
  var updateViewerCount = function(eventId) {
    send('put', 'ViewerCount', eventId, { viewerCount: _viewerCount[eventId] });
  };

  return { send, sendToUser };
}
